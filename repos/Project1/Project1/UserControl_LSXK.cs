...
namespace Project1
{
    public partial class UserControl_LSXK : UserControl
    {
        ...
        public UserControl_LSXK()
        {
            InitializeComponent();
        }

        private void UserControl_LSXK_Load(object sender, EventArgs e)
        {
            try
            {
                conn = new SqlConnection("Server = MSI\\SQLEXPRESS; Database = CAFE; User Id = sa; pwd = 123456;");
                cmd = new SqlCommand("Select * from LSXuatKho", conn);
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            if (check == true)
            {
                ...
                conn.Open();
                String sqlStr = "Select LSXuatKho.MaVP, TenVP, LSXuatKho.SoLuong from LSXuatKho, Kho " +
                            "where LSXuatKho.MaVP = Kho.MaVP and LSXuatKho.MaNV = '" + manv + "' and NgayTH = '" + ngay + "';";
                try
                {
                    ...
                    gBoxContain.Text = "Lịch Sử Xuất Kho Ngày: " + ngay;
            ...
            {
                MessageBox.Show("Không có lịch sử xuất kho của Nhân Viên " + manv + " vào ngày: " + ngay);
            }
        }
        ...
        private Boolean Check_CSDL()
        {
            ...
            int flag = 0;
            String sqlStr = "Select TenNV from LSXuatKho, NhanVien where LSXuatKho.MaNV = NhanVien.MaNV and LSXuatKho.MaNV = '"
        ...
        private void ToExcel(String filename)
        {
            ...
            try
            {
                ...
                worksheet.Name = "Lịch Sử Xuất Kho";
